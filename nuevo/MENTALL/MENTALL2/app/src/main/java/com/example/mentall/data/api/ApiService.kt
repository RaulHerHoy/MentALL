...
interface ApiService {
    ...
    // ========== User Profile ==========
    @PUT("user/update_name.php")
    suspend fun updateUserName(@Body request: UpdateNameRequest): Response<ApiResponse<User>>

    @PUT("user/update_password.php")
    suspend fun updateUserPassword(@Body request: UpdatePasswordRequest): Response<ApiResponse<Any>>

    @GET("user/profile.php")
    suspend fun getUserProfile(@Query("id_usuario") idUsuario: Int): Response<ApiResponse<User>>
    ...
    suspend fun deleteContact(@Query("id_contacto") idContacto: Int): Response<ApiResponse<Any>>
